class Algorithms:
    ...
    def merge_sort(self, A, start, end):
        ...
        yield from self.merge_sort(A, start, mid)
        yield from self.merge_sort(A, mid + 1, end)
    ...
    def quick_sort(self, A, start, end):
        ...
        yield from self.quick_sort(A, start, pivotIdx - 1)
        yield from self.quick_sort(A, pivotIdx + 1, end)
